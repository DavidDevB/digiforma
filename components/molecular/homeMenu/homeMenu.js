        ...
        `<div class="V2_LeftMenuLayout__nav">
            <nav class="SidebarNavigationContent">
                <ul class="SidebarNavigationContent__navigation-container">
                    ...
                    <li class="SidebarNavigationContent__navigation"> <a class="SidebarNavigationContent__navigation_a"  href="/pages/wip/wip.html">${IconCircle(icons.check, { bgColor: "transparent", color: window.location.pathname.includes("check") ? "rgb(166, 77, 144)" : "black" })} Emargements</a></li>
                    ...
                    <li class="SidebarNavigationContent__navigation"> <a class="SidebarNavigationContent__navigation_a"  href="/pages/wip/wip.html">${IconCircle(icons.info, { bgColor: "transparent", color: window.location.pathname.includes("info") ? "rgb(166, 77, 144)" : "black" })} A propos</a></li>
               ${renderSessionAccess({
            id: "sessions-access",
            sessions: [
