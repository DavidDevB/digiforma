        ...
        `<div class="V2_LeftMenuLayout__nav">
            <nav class="SidebarNavigationContent">
                <ul class="SidebarNavigationContent__navigation-container">
                    ...
                    <li class="SidebarNavigationContent__navigation"> <a class="SidebarNavigationContent__navigation_a"  href="/pages/signature/signature.html" style="color:${window.location.pathname.includes("signature") ? " rgb(166, 77, 144) " : "black"}">${IconCircle(icons.check, { bgColor: "transparent", color: window.location.pathname.includes("signature") ? "rgb(166, 77, 144)" : "black" })} Emargements</li>
